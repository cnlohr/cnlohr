...
Single-file <IMG SRC=https://github.com/user-attachments/assets/b1c1cd97-05fb-4b97-a392-3a72dcd74948> header libraries:
 ...
 * [<IMG SRC=http://cnvr.io/d/ghsai.cgi?cnlohr/fix32_fft&6>fix32_fft](https://github.com/cnlohr/fix32_fft) - modern C fixed-point FFT library geared for 32-bit systems, like ARM and RISC-V.
 * [<IMG SRC=http://cnvr.io/d/ghsai.cgi?cnlohr/vpxcoding&6>vpxcoding](https://github.com/cnlohr/vpxcoding) - VPX arithmatic coding library for bit compression with a tiny code/memory footprint.
 * [<IMG SRC=http://cnvr.io/d/ghsai.cgi?cnlohr/cnrbtree&6>cnrbtree](https://github.com/cnlohr/cnrbtree) - Basically a c++ `<map>` or Dictionary in C, as a single file header.
 * [<IMG SRC=http://cnvr.io/d/ghsai.cgi?cnlohr/heatshrink-sfh&6>heatshrink-sfh](https://github.com/cnlohr/heatshrink-sfh) - Extremely simple implemenation of heatshrink for decompressing data in <600 bytes.
 * [<IMG SRC=http://cnvr.io/d/ghsai.cgi?cnlohr/rtgz-tinf-util&6>rtgz-tinf-util](https://github.com/cnlohr/rtgz-tinf-util) - Very small port of tinfl, a gzip decompressor in a header only library.
